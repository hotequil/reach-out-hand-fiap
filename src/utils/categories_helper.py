...
conflicted_category_error = f"{CategoryType.EMPLOYEE.value} ou {CategoryType.DONOR.value.lower()} não pode estar junto com a categoria {CategoryType.SERVED.value.lower()}"
